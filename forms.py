...
from wtforms.validators import InputRequired, URL, Email, Regexp
...
class RegisterForm(FlaskForm):
    ...
    password = PasswordField("Password", validators=[InputRequired(), Regexp("\d", message="Password must include number")])
